...
|---|---|---|---|---|---|---|---|
| BG-Q1 | BG | 项目背景及必要性 | 近年船舶电气设计智能化相关政策、行业背景和建设意义依据是什么 | 船舶 电气设计 智能化 建设背景 建设意义 政策 2024 2025 2026 | 政策/行业报告 | 4 | 待检索 |
| BG-Q2 | BG | 国内外发展现状及前景 | 国内外同类平台、代表性产品、痛点分析和发展前景是什么 | 船舶 工业软件 国内外发展现状 痛点 发展前景 PLM PDM | 官方产品页/行业报告/论文 | 6 | 待检索 |
```
