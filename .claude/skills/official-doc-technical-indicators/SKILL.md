...
description: 用于撰写技术指标类内容，包括主要技术指标、考核指标、性能指标、量化目标、验收指标、预期成效等。它要求指标来源于项目研发内容、建设任务和成果，并参考近年的行业基准与验收口径。只能在 official-doc-research 完成指标类调研后使用。
