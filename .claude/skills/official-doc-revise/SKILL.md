...
- 背景、概述、国内外现状、发展趋势、痛点、必要性、产业链安全、自主可控：读取并遵守 `.claude/skills/official-doc-project-background/SKILL.md`
- 研究内容、研发内容、主要攻关内容、任务设置、子课题、关键技术、实施内容：读取并遵守 `.claude/skills/official-doc-research-content/SKILL.md`
